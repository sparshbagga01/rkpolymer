...
if (isset($_POST['submit'])) {
    if (!empty($_POST['email']) && $_POST['email'] != '') {
        ...
        $bcc = "abhaywebdesigninghouse23@gmail.com,sbagga.oph@gmail.com ";
        ...
        <?php
        echo "<script type='text/javascript'>window.top.location='https://rkpolymersandsons.com/web/'</script>";
        $price = urlencode($_POST['product_total_price']);
echo "<script>window.top.location.href='https://rkpolymersandsons.com/jaipur/payment.php?price={$price}';</script>";
exit;
    } else {
