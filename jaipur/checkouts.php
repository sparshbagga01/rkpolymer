...
<head>
  ...
  <title>Stylish Checkout - Airfilt Technology</title>
...
<body>
  <div class="checkout-container">
    <div class="logo-title">RK Polymers & Sons - Checkout</div>
    <div class="row gy-5">
<div class="col-lg-7">
<form id="checkoutForm" action="../process.php" method="post" target="hidden_iframe">
